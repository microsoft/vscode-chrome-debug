    ...
    */
	export interface StoppedEvent extends Event {
		body: {
			...
			threadId?: number;
			/** The source where the execution has stopped. If source is null or does not exist, the debuggee has stopped, but it is not known where. */
			source?: Source;
			/** The line where the execution has stopped. If source is null or doesn't exist, line is 0 and must be ignored. */
			line: number;
			/** The column where the execution has stopped. If source is null or doesn't exist, column is 0 and must be ignored. */
			column: number;
