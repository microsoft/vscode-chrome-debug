...
export function getBrowserLaunchCommand(): string {
    ...
    if (platform === coreUtils.Platform.OSX) {
        ...
        if (coreUtils.existsSync(CHROME_LAUNCH_COMMANDS.WINx86)) {
            return CHROME_LAUNCH_COMMANDS.WINx86;
        } else if (coreUtils.existsSync(CHROME_LAUNCH_COMMANDS.WIN)) {
            return CHROME_LAUNCH_COMMANDS.WIN;
        } else if (coreUtils.existsSync(CHROME_LAUNCH_COMMANDS.WIN_LOCALAPPDATA)) {
